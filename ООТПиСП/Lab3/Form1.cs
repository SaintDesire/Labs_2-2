...
namespace Lab3
{
    public partial class Form1 : Form
    {
        ...
        {
            // Записываем ссылку на элемент, на который наведен курсор мыши, в переменную
            lastHoveredControl = sender as Control;
        }

        // Создаем обработчик события Click для кнопки "Удалить"
        private void deleteButton_Click(object sender, EventArgs e)
        {
            // Вызываем метод очистки последнего наведенного элемента
            ClearLastHoveredControl();
        }

        // Создаем метод для очистки последнего наведенного элемента
        private void ClearLastHoveredControl()
        {
            if (lastHoveredControl != null)
            {
                ...
                {
                    // Сбрасываем выбранное значение в комбобоксе
                ...
                {
                    // Если элемент не поддерживается, то выводим сообщение об ошибке
                    MessageBox.Show("Этот элемент не поддерживается!");
                }
            }
        }
        ...
        {
            MessageBox.Show("Версия программы: 2.1 \nФИО разработчика: Коршун Никита Игоревич", "О программе");
        }
        ...
        {
            MessageBox.Show("Предыдущих страниц нет!");
        }
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            // Код для добавления объекта
            if (objectCount >= 0)
            {
                objectCount++; // увеличиваем счетчик объектов

                // Обновляем текст в строке состояния
                toolStripStatusLabel2.Text = $"Добавлен объект. Всего объектов: {objectCount}. {DateTime.Now.ToString()}";
            }
        }
        ...
        private void button15_Click(object sender, EventArgs e)
        {
            ...
            if (objectCount > 0)
            {
                objectCount--; // уменьшаем счетчик объектов

                // Обновляем текст в строке состояния
                toolStripStatusLabel2.Text = $"Удален объект. Всего объектов: {objectCount}. {DateTime.Now.ToString()}";
            }
        }
    }
}