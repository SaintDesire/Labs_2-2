...
public class FilterAdd implements Filter {
    ...
    static {
        new DOMConfigurator().doConfigure("C:\\Users\\Admin\\Desktop\\labs\\labs 2_2\\Java\\Lab10\\Lab10\\src\\main\\java\\com\\example\\lab10\\log\\log4j.xml", LogManager.getLoggerRepository());
    }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        String connectionString = "jdbc:mysql://localhost:3306/rugby_teams?autoReconnect=true&useSSL=false";
        try {
